defmodule Day17 do
  ...
  # Copied solution from thth https://github.com/thth/aoc_2020/blob/master/16.exs

  def count_active_cubes do
    # "inputs/day17_test1_input.txt")
    get_init_cubes()
    |> parse
  ...
  this initial state represents a small 2-dimensional slice of it. (In particular, this initial state defines a 3x3x1x1 region of the 4-dimensional space.)
  ...
  defp get_init_cubes(input \\ "inputs/day17_input.txt") do
    File.read!(input)
  end
end
