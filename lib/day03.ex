defmodule Day03 do
  ...
  defp count_trees([], _slope_right, _slope_down, _right_pos, _down_pos, tree_count), do: tree_count
    ...
    case Enum.at(tree_lines, next_down_pos) do
      ...
      tree_line ->
        if tree_encountered?(tree_line, next_right_pos) do
          count_trees(tree_lines, slope_right, slope_down, next_right_pos, next_down_pos, tree_count + 1)
        else
          count_trees(tree_lines, slope_right, slope_down, next_right_pos, next_down_pos, tree_count)
        end
      end
  end
